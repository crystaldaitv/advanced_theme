(function ($) {
    $(document).ready(function () {
        ...
        if (typeof menu_entry_js.ag_theme_option !== 'undefined') {
            custom.customCss  = typeof (menu_entry_js.ag_theme_option.customCss !== 'undefined') ? menu_entry_js.ag_theme_option.customCss : '';
            custom.customHead  = typeof (menu_entry_js.ag_theme_option.customHead !== 'undefined') ? menu_entry_js.ag_theme_option.customHead : '';
            custom.customBody  = typeof (menu_entry_js.ag_theme_option.customBody !== 'undefined') ? menu_entry_js.ag_theme_option.customBody : '';
        }
        ...
        function showFooterOption() {
            if ($('#ag_style_footer').prop('checked') === true) {
                $('#footer_template').show();
            } else {
                $('#footer_template').hide();
            }
        }
        $('#ag_style_footer').on('change', function (e) {
            showFooterOption();
        });
        showFooterOption();
        ...
        $('#theme_setting').find('#saveTable').on('click', function (e) {
            ...
            optionSave.postsPerPage = $advanced_theme.find('#ag_global_posts_per_page').val();
            ...
            if ($advanced_theme.find('#ag_breadcrumb').prop('checked') === true) {
                optionSave.agBreadcrumb = '1';
            } else {
                optionSave.agBreadcrumb = '0';
            }
            if ($advanced_theme.find('#ag_style_footer').prop('checked') === true) {
                optionSave.styleFooter = '1';
            } else {
                optionSave.styleFooter = '0';
            }

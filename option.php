...
$globalPostsPerPage  = get_option('posts_per_page', 10); ?>
...
<div id="theme_option" class="tab-pane">
    ...
    <div class="ju-settings-option full-width wordpress">
        <div class="custom_head ju-settings-option">
            <label class="tooltip ju-setting-label" data-toggle="tooltip" data-placement="top" title="
                <?php esc_attr_e('Select the number of Posts to display on the category listing pages (blog)', 'advanced-theme'); ?>">
        ...
        <div class="custom_body ju-settings-option">
            <label class="tooltip ju-setting-label" data-toggle="tooltip" data-placement="top" title="
                <?php esc_attr_e('Select the number of Posts to display on the archive listing views', 'advanced-theme'); ?>">
        ...
        <div class="custom_head ju-settings-option">
            <label class="tooltip ju-setting-label" data-toggle="tooltip" data-placement="top" title="
                <?php esc_attr_e('Select the number of Posts to display on the WordPress post search engine', 'advanced-theme'); ?>">
        ...
        <div class="custom_body ju-settings-option">
            <label class="tooltip ju-setting-label" data-toggle="tooltip" data-placement="top" title="
                <?php esc_attr_e('Select the number of Posts to display on the tag listing views', 'advanced-theme'); ?>">
        ...
        <div class="custom_body ju-settings-option">
            <label class="tooltip ju-setting-label" data-toggle="tooltip" data-placement="top"
                   title="<?php esc_attr_e( 'Select the number of Posts to display on the posts listing views','advanced-theme' ); ?>">
                <?php esc_attr_e('Global posts per page:', 'advanced-theme'); ?>
            </label>
            <div class="ag-box-content">
                <input class=" ju-input" id="ag_global_posts_per_page" type="number" value="<?php echo $globalPostsPerPage; ?>">
            </div>
        </div>
        <div class="custom_body ju-settings-option">
            <label class="tooltip ju-setting-label" data-toggle="tooltip" data-placement="top" title="
            ...
            <div class="ag-box-content ju-switch-button">
                <label class="switch">
                    <input type="checkbox" name="your-setting-name" id="ag_breadcrumb"
                           value="1" <?php echo (isset( $optionThemeSettings['agBreadcrumb']) && (int) $optionThemeSettings['agBreadcrumb'] === 1) ? 'checked' : ''?> />
            ...
            <div class="ag-box-content ju-switch-button">
                <label class="switch">
                    <input type="checkbox" name="your-setting-name" id="ag_style_footer"
                           value="1" <?php echo (isset($optionThemeSettings['styleFooter']) && (int) $optionThemeSettings['styleFooter'] === 1) ? 'checked' : ''?> />
    ...
    <div class="custom_body ju-settings-option full-width" id="footer_template">
        <label class="tooltip ju-setting-label" data-toggle="tooltip" data-placement="top" title="
            <?php esc_attr_e('Select the background image for the footer according to the pattern', 'advanced-theme'); ?>">
            <?php esc_attr_e('Background image for footer:', 'advanced-theme'); ?>
        </label>
        <div class="ag-box-content">
            <select id="ag_template" class="ju-select">
                <option value="none"> <?php esc_attr_e('— Select Template —', 'advanced-theme');?> </option>
            </select>

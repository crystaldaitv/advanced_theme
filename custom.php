...
<div id="custom_code" class="tab-pane">
    <div class="custom_css ag-box-1 ju-settings-option full-width">
        ...
        <?php esc_attr_e('Custom CSS', 'advanced-theme'); ?>:</label>

        <div class="ag-box-content">
            <textarea id="custom_css" name="codesnippet_readonly"></textarea>
        </div>
    ...
    <div class="custom_head ag-box-1 ju-settings-option full-width">
        ...
        <?php esc_html_e('< head > custom code', 'advanced-theme'); ?>:</label>

        <div class="ag-box-content">
            <textarea id="custom_head" name="codesnippet_readonly"></textarea>
        </div>
        <span class="ag-box-description"></span>
    </div>
    ...
    <div class="custom_body ag-box-1 ju-settings-option full-width">
        ...
        <?php esc_html_e('< body > custom code', 'advanced-theme'); ?>
        :</label>

        <div class="ag-box-content">
            <textarea id="custom_body" name="codesnippet_readonly"></textarea>
        </div>
        <span class="ag-box-description"></span>
    </div>
</div>
